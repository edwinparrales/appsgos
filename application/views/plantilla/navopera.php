...
<!--                                <li><a href="<?php echo base_url('usuario') ?>">Usuarios</a></li>-->
                ...
                <li><a href="<?php echo base_url('Cservicio')?>">Servicios</a></li></li>
                  ...
                  <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Imprimir <span class="glyphicon glyphicon-print"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url('Creportespdf')?>">Comprobantes de orden</a></li>
